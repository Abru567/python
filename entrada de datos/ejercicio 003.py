...
# muestre por pantalla un mensaje que indique cuántos años tendrá la persona después de sumarle a su edad
...
cantidad = int(input("ingrese una cantidad de años: "))
